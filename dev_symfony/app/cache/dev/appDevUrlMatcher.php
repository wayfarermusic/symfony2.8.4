...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '/admin') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'system_core_admin_index');
            }
        ...
        if (rtrim($pathinfo, '/') === '/admin/setting') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'admin_setting');
            }

            return array (  '_controller' => 'System\\CoreBundle\\Controller\\Setting\\SettingController::indexAction',  '_route' => 'admin_setting',);
        }
